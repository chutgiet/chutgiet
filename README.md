...
**Highlights:**
- Building **TraceReplay AI** — an audit-grade replay & lineage platform for enterprise AI agents using OpenTelemetry, Python, and TypeScript
- Designed & shipped **custom APIs** serving multiple business units with secure, scalable cross-system integrations
- Built a **Washout Management System** integrating GIS, Maps API, and Azure SQL for provincial highway infrastructure
- Created **AI-powered tools** — incident search systems and intelligent PDF scrapers — automating government workflows
